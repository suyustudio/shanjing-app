...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/w;->v:Li0/l$g;
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/w;->t:Lio/flutter/embedding/android/c0;

    return-void
.end method

.method static synthetic A(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/k;Li0/l$d;)J
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/w;->J(Lio/flutter/plugin/platform/k;Li0/l$d;)J
...
.method private H(Lio/flutter/plugin/platform/k;Li0/l$d;)V
    .locals 1
    ...
    invoke-static {p2, p1}, Lw/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method private J(Lio/flutter/plugin/platform/k;Li0/l$d;)J
    .locals 10
    ...
    invoke-static {v1, v0}, Lw/b;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-wide v1, p2, Li0/l$d;->c:D

    invoke-direct {p0, v1, v2}, Lio/flutter/plugin/platform/w;->w0(D)I

    move-result v5

    iget-wide v1, p2, Li0/l$d;->d:D
    ...
    iget v7, p2, Li0/l$d;->a:I

    new-instance v9, Lio/flutter/plugin/platform/u;

    invoke-direct {v9, p0, p2}, Lio/flutter/plugin/platform/u;-><init>(Lio/flutter/plugin/platform/w;Li0/l$d;)V
    ...
    invoke-interface {p1}, Lio/flutter/plugin/platform/k;->l()Landroid/view/View;
    ...
    iget-object v1, p2, Li0/l$d;->b:Ljava/lang/String;
...
.method private R()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/w;->v:Li0/l$g;

    invoke-interface {v1, v0}, Li0/l$g;->i(I)V
...
.method private T(Li0/l$d;)V
    .locals 3

    iget v0, p1, Li0/l$d;->g:I
...
.method private U(Z)V
    ...
    iget-object v2, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/s;

    invoke-virtual {v2, v4}, Lio/flutter/embedding/android/s;->m(Lio/flutter/embedding/android/k;)V

    invoke-virtual {v4}, Lio/flutter/embedding/android/k;->e()Z
    ...
    invoke-virtual {v4}, Lio/flutter/embedding/android/k;->a()V
...
.method private Y()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/s;
...
.method private synthetic Z(Li0/l$d;Landroid/view/View;Z)V
    .locals 0

    if-eqz p3, :cond_0

    iget-object p2, p0, Lio/flutter/plugin/platform/w;->g:Li0/l;

    iget p1, p1, Li0/l$d;->a:I

    invoke-virtual {p2, p1}, Li0/l;->d(I)V
...
.method private synthetic a0(Li0/l$d;Landroid/view/View;Z)V
    .locals 0
...
.method private d0(Lio/flutter/plugin/platform/a0;)V
    .locals 1
...
.method private static e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/o;
    ...
    invoke-static {v2, v0}, Lw/b;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static synthetic f(Lio/flutter/plugin/platform/w;Li0/l$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/w;->a0(Li0/l$d;Landroid/view/View;Z)V
...
.method private f0(Lio/flutter/plugin/platform/k;)V
    ...
    invoke-static {p1, v0}, Lw/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p1, v0}, Lio/flutter/plugin/platform/k;->m(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic g(Lio/flutter/plugin/platform/w;Li0/l$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/w;->Z(Li0/l$d;Landroid/view/View;Z)V
...
.method static synthetic j(Lio/flutter/plugin/platform/w;Li0/l$d;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/w;->T(Li0/l$d;)V
...
.method static synthetic l(Lio/flutter/plugin/platform/w;D)I
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/w;->w0(D)I
...
.method static synthetic n(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/a0;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/w;->d0(Lio/flutter/plugin/platform/a0;)V
...
.method static synthetic o(Lio/flutter/plugin/platform/w;D)I
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/w;->t0(D)I
...
.method private r0()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/s;
...
.method static synthetic s(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/a0;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/w;->x0(Lio/flutter/plugin/platform/a0;)V
...
.method static synthetic t(Lio/flutter/plugin/platform/w;DF)I
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/w;->u0(DF)I
...
.method private t0(D)I
    ...
    invoke-direct {p0, p1, p2, v0}, Lio/flutter/plugin/platform/w;->u0(DF)I
...
.method static synthetic u(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/k;Li0/l$d;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/w;->H(Lio/flutter/plugin/platform/k;Li0/l$d;)V
...
.method static synthetic x(Lio/flutter/plugin/platform/w;)Lio/flutter/embedding/android/s;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/s;

    return-object p0
.end method

.method private x0(Lio/flutter/plugin/platform/a0;)V
    .locals 1
...
# virtual methods
.method public C(Landroid/content/Context;Lio/flutter/view/TextureRegistry;Lx/a;)V
    .locals 1
    ...
    invoke-direct {p1, p3}, Li0/l;-><init>(Lx/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/w;->g:Li0/l;

    iget-object p2, p0, Lio/flutter/plugin/platform/w;->v:Li0/l$g;

    invoke-virtual {p1, p2}, Li0/l;->e(Li0/l$g;)V
...
.method public F(Lio/flutter/embedding/android/s;)V
    ...
    iput-object p1, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/s;
    ...
    invoke-interface {v0, v1}, Lio/flutter/plugin/platform/k;->m(Landroid/view/View;)V
...
.method public I(Lio/flutter/plugin/platform/k;Li0/l$d;)J
    .locals 9
    ...
    iget-wide v0, p2, Li0/l$d;->c:D

    invoke-direct {p0, v0, v1}, Lio/flutter/plugin/platform/w;->w0(D)I
    ...
    iget-wide v6, p2, Li0/l$d;->e:D

    invoke-direct {p0, v6, v7}, Lio/flutter/plugin/platform/w;->w0(D)I

    move-result v6

    iget-wide v7, p2, Li0/l$d;->f:D

    invoke-direct {p0, v7, v8}, Lio/flutter/plugin/platform/w;->w0(D)I
    ...
    invoke-direct {v0, p0, p2}, Lio/flutter/plugin/platform/t;-><init>(Lio/flutter/plugin/platform/w;Li0/l$d;)V
...
.method public K()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v3, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/s;
...
.method public M(Li0/l$d;Z)Lio/flutter/plugin/platform/k;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0x13
    .end annotation
    ...
    iget-object v1, p1, Li0/l$d;->b:Ljava/lang/String;
    ...
    iget-object v2, p1, Li0/l$d;->i:Ljava/nio/ByteBuffer;

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/l;->b()Lj0/i;

    move-result-object v1

    iget-object v2, p1, Li0/l$d;->i:Ljava/nio/ByteBuffer;

    invoke-interface {v1, v2}, Lj0/i;->b(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    invoke-interface {p2}, Lio/flutter/plugin/platform/k;->l()Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_2

    iget v1, p1, Li0/l$d;->g:I
    ...
    iget-object p1, p1, Li0/l$d;->b:Ljava/lang/String;
...
.method public N()V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/android/k;->a()V

    invoke-virtual {v1}, Lio/flutter/embedding/android/k;->g()V
...
.method public O()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/w;->g:Li0/l;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Li0/l;->e(Li0/l$g;)V

    :cond_0
    invoke-virtual {p0}, Lio/flutter/plugin/platform/w;->N()V

    iput-object v1, p0, Lio/flutter/plugin/platform/w;->g:Li0/l;
...
.method public P()V
    ...
    invoke-direct {p0}, Lio/flutter/plugin/platform/w;->r0()V

    const/4 v1, 0x0

    iput-object v1, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/s;
    ...
    invoke-interface {v1}, Lio/flutter/plugin/platform/k;->n()V
...
.method X(I)V
    ...
    invoke-direct {v1, v2, v3, v4}, La0/a;-><init>(Landroid/content/Context;FLio/flutter/embedding/android/c;)V
    ...
    invoke-virtual {v1, v2}, La0/a;->setOnDescendantFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
    ...
    iget-object p1, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/s;
...
.method public k0(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v6}, La0/a;->a(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;IIII)V
    ...
    invoke-interface {p3}, Lio/flutter/plugin/platform/k;->l()Landroid/view/View;
...
.method public v0(FLi0/l$f;Z)Landroid/view/MotionEvent;
    .locals 19

    move-object/from16 v0, p2

    iget-wide v1, v0, Li0/l$f;->p:J
    ...
    iget-object v3, v2, Lio/flutter/plugin/platform/w;->t:Lio/flutter/embedding/android/c0;
    ...
    iget-object v1, v0, Li0/l$f;->g:Ljava/lang/Object;
    ...
    iget-object v1, v0, Li0/l$f;->b:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v3

    iget-object v1, v0, Li0/l$f;->c:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v5

    iget v7, v0, Li0/l$f;->d:I

    iget v8, v0, Li0/l$f;->e:I

    iget v11, v0, Li0/l$f;->h:I

    iget v12, v0, Li0/l$f;->i:I

    iget v13, v0, Li0/l$f;->j:F

    iget v14, v0, Li0/l$f;->k:F

    iget v15, v0, Li0/l$f;->l:I

    iget v1, v0, Li0/l$f;->m:I

    iget v2, v0, Li0/l$f;->n:I

    iget v0, v0, Li0/l$f;->o:I
