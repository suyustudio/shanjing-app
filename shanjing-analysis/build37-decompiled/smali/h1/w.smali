...
.method static constructor <clinit>()V
    ...
    :cond_0
    invoke-static {v0}, Lg1/d;->f(Ljava/lang/String;)Ljava/lang/Integer;
...
.method public static synthetic o()V
    ...
    invoke-static {}, Lh1/w;->x()V

    return-void
.end method

.method public static synthetic p(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Runnable;)Ljava/lang/Thread;
    .locals 0

    invoke-static {p0, p1}, Lh1/w;->s(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Runnable;)Ljava/lang/Thread;
...
.method private final r()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lh1/w;->v()I

    move-result v1

    new-instance v2, Lh1/u;

    invoke-direct {v2, v0}, Lh1/u;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method private final t()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lh1/w;->r()Ljava/util/concurrent/ExecutorService;
    ...
    :cond_3
    sget-object v4, Lh1/w;->f:Lh1/w;

    invoke-virtual {v4, v1, v2}, Lh1/w;->w(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
...
.method private final declared-synchronized u()Ljava/util/concurrent/Executor;
    ...
    :try_start_0
    sget-object v0, Lh1/w;->pool:Ljava/util/concurrent/Executor;

    if-nez v0, :cond_0

    invoke-direct {p0}, Lh1/w;->t()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lh1/w;->pool:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final v()I
    ...
    invoke-static {v0, v2}, Ld1/d;->a(II)I
...
.method public g(Ls0/g;Ljava/lang/Runnable;)V
    ...
    :try_start_0
    sget-object p1, Lh1/w;->pool:Ljava/util/concurrent/Executor;

    if-nez p1, :cond_0

    invoke-direct {p0}, Lh1/w;->u()Ljava/util/concurrent/Executor;
    ...
    sget-object p1, Lh1/n0;->j:Lh1/n0;

    invoke-virtual {p1, p2}, Lh1/w0;->E(Ljava/lang/Runnable;)V
