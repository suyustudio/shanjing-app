...
.method public static final e(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lr0/a0;->c(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_1
    invoke-static {}, Lr0/b0;->d()Ljava/util/Map;
...
.method public static g(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lr0/b0;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lr0/a0;->b(Lq0/j;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lr0/b0;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lr0/b0;->e(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lr0/b0;->f(Ljava/util/Map;Ljava/lang/Iterable;)V
