...
.method private final addListener(Ljava/util/concurrent/Executor;Landroidx/core/util/a;Lk1/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1}, Lh1/d1;->a(Ljava/util/concurrent/Executor;)Lh1/f0;

    move-result-object p1

    invoke-static {p1}, Lh1/j0;->a(Ls0/g;)Lh1/i0;
    ...
    invoke-direct {v4, p3, p2, v5}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lk1/b;Landroidx/core/util/a;Ls0/d;)V

    const/4 v5, 0x3

    const/4 v6, 0x0

    invoke-static/range {v1 .. v6}, Lh1/g;->b(Lh1/i0;Ls0/g;Lh1/k0;La1/p;ILjava/lang/Object;)Lh1/k1;
...
.method private final removeListener(Landroidx/core/util/a;)V
    ...
    invoke-static {v1, v3, v2, v3}, Lh1/k1$a;->a(Lh1/k1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
...
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/core/util/a;)V
    ...
    invoke-interface {v0, p1}, Landroidx/window/layout/WindowInfoTracker;->windowLayoutInfo(Landroid/app/Activity;)Lk1/b;

    move-result-object p1

    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Landroidx/core/util/a;Lk1/b;)V
...
.method public windowLayoutInfo(Landroid/app/Activity;)Lk1/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
