...
.method constructor <init>(Li0/j;)V
    ...
    iput-object p1, p0, Li0/j$a;->a:Li0/j;
...
.method public h(Lj0/j;Lj0/k$d;)V
    ...
    iget-object v1, p0, Li0/j$a;->a:Li0/j;

    invoke-static {v1}, Li0/j;->a(Li0/j;)Li0/j$h;
    ...
    invoke-interface {v1, p1}, Li0/j$h;->r(Ljava/lang/String;)V

    :cond_2
    :goto_1
    invoke-interface {p2, v3}, Lj0/k$d;->a(Ljava/lang/Object;)V

    goto/16 :goto_8

    :pswitch_1
    iget-object p1, p0, Li0/j$a;->a:Li0/j;

    invoke-static {p1}, Li0/j;->a(Li0/j;)Li0/j$h;

    move-result-object p1

    invoke-interface {p1}, Li0/j$h;->t()Z
    ...
    invoke-interface {v1, p1}, Li0/j$h;->m(Ljava/lang/String;)V
    ...
    :try_start_2
    invoke-static {p1}, Li0/j$e;->b(Ljava/lang/String;)Li0/j$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Lj0/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_3
    move-object p1, v3

    :goto_2
    iget-object v2, p0, Li0/j$a;->a:Li0/j;

    invoke-static {v2}, Li0/j;->a(Li0/j;)Li0/j$h;

    move-result-object v2

    invoke-interface {v2, p1}, Li0/j$h;->n(Li0/j$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p1}, Li0/j$h;->b()V
    ...
    invoke-interface {v1, p1}, Li0/j$h;->g(Z)V
    :try_end_3
    ...
    invoke-static {v1, p1}, Li0/j;->f(Li0/j;Lorg/json/JSONObject;)Li0/j$j;
    ...
    invoke-interface {v1, p1}, Li0/j$h;->p(Li0/j$j;)V
    ...
    invoke-interface {p1}, Li0/j$h;->l()V
    ...
    invoke-interface {p1}, Li0/j$h;->k()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Li0/j;->e(Li0/j;Ljava/lang/String;)Li0/j$k;
    ...
    invoke-interface {v1, p1}, Li0/j$h;->i(Li0/j$k;)V
    ...
    invoke-static {v1, p1}, Li0/j;->d(Li0/j;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Li0/j$h;->j(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Li0/j;->c(Li0/j;Lorg/json/JSONObject;)Li0/j$c;
    ...
    invoke-interface {v1, p1}, Li0/j$h;->h(Li0/j$c;)V
    ...
    invoke-static {v1, p1}, Li0/j;->b(Li0/j;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Li0/j$h;->q(I)V
    ...
    invoke-static {p1}, Li0/j$g;->b(Ljava/lang/String;)Li0/j$g;
    ...
    invoke-interface {v1, p1}, Li0/j$h;->s(Li0/j$g;)V
    ...
    invoke-static {p1}, Li0/j$i;->b(Ljava/lang/String;)Li0/j$i;
    ...
    invoke-interface {v1, p1}, Li0/j$h;->o(Li0/j$i;)V
